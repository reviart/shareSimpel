                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ route('register') }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group{{ $errors->has('nim') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="nim" type="text" class="form-control" name="nim" value="{{ old('nim') }}" required autofocus autocomplete="on">
                                @if ($errors->has('nim'))
                        ...
                        <div class="form-group{{ $errors->has('alamat') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <textarea name="alamat" rows="3" cols="45" type="text" class="form-control" required></textarea>
