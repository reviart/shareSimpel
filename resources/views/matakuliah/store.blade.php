                ...
                <div class="panel-body">
                  <form class="form-horizontal" role="form" method="POST" action="{{ route('matakuliah.store.submit') }}">
                      ...
                      <div class="form-group{{ $errors->has('kode_mk') ? ' has-error' : '' }}">
                          ...
                          <div class="col-md-6">
                              <input id="kode_mk" type="text" class="form-control" name="kode_mk" value="{{ old('kode_mk') }}" required autofocus>
                      ...
                      <div class="form-group{{ $errors->has('sks') ? ' has-error' : '' }}">
                          ...
                          <div class="col-md-6">
                              <input id="sks" type="text" class="form-control" name="sks" value="{{ old('sks') }}" required>
                      ...
                      <div class="form-group{{ $errors->has('seksi') ? ' has-error' : '' }}">
                          ...
                          <div class="col-md-6">
                              <input id="seksi" type="text" class="form-control" name="seksi" value="{{ old('seksi') }}" required>
                      ...
                      <div class="form-group{{ $errors->has('dosen') ? ' has-error' : '' }}">
                          ...
                          <div class="col-md-6">
                              <input id="dosen" type="text" class="form-control" name="dosen" value="{{ old('dosen') }}" required>
                      ...
                      <div class="form-group{{ $errors->has('lecture_started') ? ' has-error' : '' }}">
                        ...
                        <div class="col-md-6">
                            <input id="lecture_started" type="time" class="form-control" name="lecture_started" value="{{ old('lecture_started') }}" required>
                      ...
                      <div class="form-group{{ $errors->has('lecture_finished') ? ' has-error' : '' }}">
                        ...
                        <div class="col-md-6">
                            <input id="lecture_finished" type="time" class="form-control" name="lecture_finished" value="{{ old('lecture_finished') }}" required>
